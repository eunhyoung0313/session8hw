...
urlpatterns = [
    ...
    path('detail_url/<int:primary_key_of_the_post_that_i_clicked>', views.detail_defined_in_view, name='detail_i_will_use_in_html'),
    ...
    path('entertainment/', views.entertainment_defined_in_view, name='entertainment_i_will_use_in_html')
]
